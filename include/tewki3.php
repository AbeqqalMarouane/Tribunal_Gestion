...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header, $data) {
        ...
        // Header
        $w = array(25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 20); // Adjusted column widths
        ...
        foreach($data as $row) {
            ...
            $this->MultiCell($w[4], 18, $row["Duree_Conge"], 'LR', 'C', $fill, 0, '', '', true);
            ...
            $this->MultiCell($w[10], 18, $row["Rest_Temp"], 'LR', 'C', $fill, 0, '', '', true);
...
// column titles
$header = array('رقم التأجير', 'رقم البطاقة الوطنية', 'الإسم الشخصي', 'الإسم العائلي', 'مدة الرخصة', 'الفترة المطلوبة', 'اسم القائم بالنيابة', 'توقيع الخروج','تاريخ الدخول','توقيع الدخول','الباقي');
// data loading
$data = $pdf->LoadData();
