...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $metierP1 = $_POST['Metier'];
    $metierP2 = $_POST['solam'];
    $metier = $metierP1 . ' من ' . $metierP2; // Concatenate role and solam
...
<body class="app">
                            ...
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <form class="table-search-form row gx-1 align-items-center">
                                        <div class="col-auto">
                                            <input type="text" id="search-orders" name="searchorders" class="form-control search-orders" placeholder="بحث">
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="mt-3">
                                        <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                                            <div class="offcanvas-header">
                                                <h5 id="offcanvasBothLabel" class="offcanvas-title">معلومات الموظف</h5>
                                            ...
                                            <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="metier" class="form-label">الإطار</label>
                                                        <select class="form-select" id="metier" name="Metier" required>
                                                            <option value="منتذب قضائي">منتذب قضائي</option>
                                                            <option value="مفوض قضائي">محرر قضائي</option>
                                                            <option value="كاتب الضبط">كاتب الضبط</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="solam" class="form-label">السلم</label>
                                                        <select class="form-select" id="solam" name="solam" required>
                                                            ...
                                                            <option value="خارج السلم">خارج السلم</option>
                                                            <option value="الدرجة الممتازة">الدرجة الممتازة</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="departement" class="form-label">المصلحة</label>
                                                        <select class="form-select" id="departement" name="departement" required>
                                                            <option value="مصلحة المنتدبين القضائيين والأطر التقنية">مصلحة المنتدبين القضائيين والأطر التقنية</option>
                                                            <option value="مصلحة كتاب الضبط والمحررين القضائيين">مصلحة كتاب الضبط والمحررين القضائيين</option>
                ...
                <div class="tab-content" id="orders-table-tab-content">
                            ...
                            <div class="app-card-body">
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row-<?= htmlspecialchars($contract['Nbr_Financier'], ENT_QUOTES, 'UTF-8'); ?>" onclick="window.location.href='userDetails.php?ID_user=<?= urlencode($contract['ID_user']); ?>'">
                                            ...
                                            <td class="cell">
                                                <?php if ($contract['status'] == 'المستمرين')
                                                    echo "<a class='btn btn-danger custom-hover-red' href='../include/handleAction.php?action=deleteUser&Nbr_Financier=" . urlencode($contract['Nbr_Financier']) . "' onclick='return confirm(\"هل انت متاكد من انك تريد الحذف ؟\")'>حذف</a>";
                                                    if ($contract['status'] == 'المتوقفين') 
                                                    echo "<a class='btn btn-warning custom-hover-red' href='../include/handleAction.php?action=RestoreUser&Nbr_Financier=" . urlencode($contract['Nbr_Financier']) . "' onclick='return confirm(\"هل انت متاكد من انك تريد الاستعادة ؟\")'>استعادة</a>";
                                                ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                        ...
                        <div class="app-card app-card-orders-table mb-5">
                            <div class="app-card-body">
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                        <?php foreach($contracts as $contract): ?>
                                        <tr id="row-<?= htmlspecialchars($contract['Nbr_Financier'], ENT_QUOTES, 'UTF-8'); ?>" onclick="window.location.href='userDetails.php?Nbr_Financier=<?= urlencode($contract['Nbr_Financier']); ?>'">
                                            <td class="cell" data-label="Nbr_Financier"><?= htmlspecialchars($contract['Nbr_Financier'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td class="cell" data-label="CIN"><?= htmlspecialchars($contract['CIN'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td class="cell" data-label="Prenom"><?= htmlspecialchars($contract['Prenom'], ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td class="cell" data-label="Nom"><?= htmlspecialchars($contract['Nom'], ENT_QUOTES, 'UTF-8'); ?></td>
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?= $page <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="?tab=<?= $tab; ?>&page=<?= $page - 1; ?>" tabindex="-1" aria-disabled="true">السابق</a>
                        </li>
                        <?php for($i = 1; $i <= $total_pages; $i++): ?>
                        <li class="page-item <?= $page == $i ? 'active' : ''; ?>"><a class="page-link" href="?tab=<?= $tab; ?>&page=<?= $i; ?>"><?= $i; ?></a></li>
                        <?php endfor; ?>
                        <li class="page-item <?= $page >= $total_pages ? 'disabled' : ''; ?>">
                            <a class="page-link" href="?tab=<?= $tab; ?>&page=<?= $page + 1; ?>">التالي</a>
                        </li>
                    </ul>
                </nav>
                </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="updateUserForm" action="../include/update_user.php" method="POST">
